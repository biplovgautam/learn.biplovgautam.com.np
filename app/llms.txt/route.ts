...
export async function GET() {
  ...
  const lines: string[] = [
    "# BiLearnHub",
    "",
    "> Open courseware on ROS 2, robotics, and intelligent systems by Biplov Gautam. Hands-on courses, focused tutorials, and in-depth articles for engineers building robots.",
    "",
    "BiLearnHub is a learning platform where Biplov Gautam publishes structured courses (organized into modules and lessons), standalone tutorials, and long-form articles on robotics. Topics include ROS 2 (Robot Operating System) — nodes, topics, services, actions, parameters — robot perception, SLAM, navigation with Nav2, manipulation with MoveIt, motion planning, control, micro-ROS, Gazebo simulation, and intelligent autonomous systems.",
    "",
    ...
    "## Author",
    "",
    "- [Biplov Gautam](https://biplovgautam.com.np): robotics engineer based in Nepal. Builds intelligent systems and teaches ROS 2 and robotics.",
    "",
    "## Top-level pages",
    "",
